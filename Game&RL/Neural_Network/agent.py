...
from keras import models, layers, optimizers, activations, losses, regularizers, metrics
...
class DQNAgent:
    ...
    def __init__(self, state_size, action_size, gamma=0.95, epsilon=0.5, epsilon_min=0.01,
                 epsilon_decay=0.98, learning_rate=0.001, buffer_size=4098):
        """
    ...
    def act(self, state):
        ...
        if random.uniform(0, 1) < 1 - self.epsilon_decay:
